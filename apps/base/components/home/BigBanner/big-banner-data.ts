...
export const bigBannerData = [
  {
    ...
    image: person01,
    description: 'بازارچه دوره‌های آموزشی علوم‌پزشکی داخلی و خارجی از بهترین ارائه دهندگان',
  ...
  },
  {
    ...
    image: person02,
    description: 'بازارچه محصولات تخصصی علوم‌پزشکی؛ از بهترین ناشران و تولیدکنندگان',
    primaryButtonLink: '/market',
  ...
  },
  {
    ...
    image: person03,
    description: 'بانک اطلاعات بیماری‌ها و داروها، دیتابیس ها و ماشین‌حساب‌های علوم‌پزشکی',
    primaryButtonLink: 'https://doctorabad.com/app',
  ...
  },
  {
    ...
    image: person05,
    description: 'بانک جامع سوالات علوم‌پزشکی با فیلتر پیشرفته،آزمون ساز، تک‌آزمون‌ها و صدور کارنامه تحلیلی',
    primaryButtonLink: '/exam',
  ...
  },
  {
    ...
    image: person06,
    description: 'نسخه‌نویسی الکترونیک بیمه‌های پایه بستر مشاوره آنلاین و خرید بیمه مسئولیت',
    primaryButtonLink: 'https://doctorabad.com/app',
