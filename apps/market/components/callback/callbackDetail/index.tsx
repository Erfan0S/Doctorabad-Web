...
const CallbackDetail = ({ isOrderSuccess, orderDate, orderId, trackingId }: Props) => {
        ...
        <div className={style.callbackDetailDetail}>
          ...
          <ul>
            <li>
              ...
              <span>
                {orderId}
                <Copy onClick={() => copyText(orderId!, 'شماره سفارش کپی شد')} />
              </span>
            </li>
            {trackingId && (
              <li>
                ...
                <span>
                  {trackingId}
                  <Copy onClick={() => copyText(trackingId!, 'کد رهگیری کپی شد')} />
                </span>
              </li>
            )}
          </ul>
