...
// ponytail: the old per-network className fields pointed at scss classes
// (.tiktok, .twitter, ...) that were never defined in Footer.module.scss,
// so they resolved to undefined. Dropped with no visual change.
