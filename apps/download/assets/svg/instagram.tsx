...
const Instagram: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
    ...
    >
      ...
      />
      <circle cx="96" cy="96" r="30" stroke={props.stroke || 'currentColor' || '#000000'} strokeWidth="12" />
      <circle cx="135" cy="57" r="9" fill={props.fill || 'currentColor' || '#000000'} />
    </svg>
  );
};
