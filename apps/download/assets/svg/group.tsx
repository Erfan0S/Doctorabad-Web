...
const Group: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M2 8H8" stroke={props.stroke || 'currentColor' || '#292D32'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M2 11H6" stroke={props.stroke || 'currentColor' || '#292D32'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M2 14H4" stroke={props.stroke || 'currentColor' || '#292D32'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
