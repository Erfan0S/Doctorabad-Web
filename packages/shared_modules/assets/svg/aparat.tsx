...
const Aparat: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    // <svg
    ...
    //       fill={props.fill || 'currentColor' || '#434343'}
    //     ></path>
    //   </g>
    // </svg>
  <svg  fill={props.fill || 'currentColor' || '#434343'} width="20px" height="20px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
