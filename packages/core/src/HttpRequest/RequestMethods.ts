...
export class RequestMethods extends RequestConstructor {
  ...
  public async post<T = unknown>(url: string, body: Object | FormData, options: RequestOptions = {}) {
  ...
  public async patch<T = unknown>(url: string, body: Object | FormData, options: RequestOptions = {}) {
    return this.request<T>(
      url,
      RequestMethod.PATCH,
      this.requestUtils.transformConfigsBasedOnBodyType(body, options)
  ...
  public async put<T = unknown>(url: string, body: Object | FormData, options: RequestOptions = {}) {
    return this.request<T>(
      url,
      RequestMethod.PUT,
      this.requestUtils.transformConfigsBasedOnBodyType(body, options)
