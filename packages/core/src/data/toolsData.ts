...
export const ALL_TOOLS: Tool[] = [
  ...
  { id: "calcium-correction", title: "Calcium Correction", description: "تصحیح غلظت کلسیم با توجه به میزان آلبومین", iconChar: "C", colorClass: "red", href: "/calcium-correction" },
  ...
  { id: "has-bled", title: "HAS-BLED Score", description: "تخمین میزان خونریزی در بیماران تحت درمان با درمان‌های ضد انعقاد", iconChar: "H", colorClass: "violet", href: "/has-bled-score" },
  { id: "cha2ds2-vasc", title: "CHA2DS2-VASC", description: "تخمین ریسک سکته مغزی در بیماران قلبی", iconChar: "C", colorClass: "blue-dark", href: "/cha2ds2-vasc" },
  { id: "chads2", title: "CHADS2", description: "تخمین ریسک سکته مغزی در بیماران قلبی", iconChar: "C", colorClass: "blue", href: "/chads2" },
  { id: "maintenance-fluids", title: "Maintenance Fluids", description: "میزان مایع نگهداره برای سرم درمانی", iconChar: "M", colorClass: "cyan", href: "/maintenance-fluids" },
  { id: "abcd2", title: "ABCD2", description: "ارزیابی خطر تکرار ایسکمی و سکته مغزی", iconChar: "A", colorClass: "teal", href: "/abcd2" },
  { id: "wells-pte", title: "Wells PTE", description: "ارزیابی خطر ترومبوآمبولی ریوی", iconChar: "W", colorClass: "green-mid", href: "/wells-pte" },
  { id: "wells-dvt", title: "Wells DVT", description: "ارزیابی خطر ترومبوآمبولی وریدی", iconChar: "W", colorClass: "lime", href: "/wells-dvt" },
];
